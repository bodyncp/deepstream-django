...
class UserInfo(models.Model):
    ...
    email = models.CharField(verbose_name='邮箱', max_length=32, blank=True, null=True, default="xx@189.cn")
    roles = models.ManyToManyField(verbose_name='拥有的所有角色', to=Role, blank=True, default=2)
